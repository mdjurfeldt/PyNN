...
parameters = {
    'neurons': {
        ...
        'tau_syn_fast_rise': {
            "exc": 2.0,  # Decay time of the fast excitatory synaptic conductance in ms.
            "inh": 2.0,  # Decay time of the fast inhibitory synaptic conductance in ms.
        },
        'tau_syn_fast_decay':  {
            "exc":      5.0,  # Decay time of the fast excitatory synaptic conductance in ms.
            "inh":      5.0,  # Decay time of the fast inhibitory synaptic conductance in ms.
         },
        'e_syn_fast': {
            'exc':      0.0,  # Reversal potential for fast excitatory input in mV
            'inh':    -70.0,  # Reversal potential for fast inhibitory input in mV
        },
        'tau_syn_slow_rise': {
            "exc": 5.0,  # Decay time of the slow excitatory synaptic conductance in ms.
            "inh": 5.0,  # Decay time of the slow inhibitory synaptic conductance in ms.
        },
        'tau_syn_slow_decay': {
            "exc": 50.0,  # Decay time of the slow excitatory synaptic conductance in ms.
            "inh": 50.0,  # Decay time of the slow inhibitory synaptic conductance in ms.
        },
        'e_syn_slow': {
            'exc': 0.0,  # Reversal potential for slow excitatory input in mV
            'inh': -90.0,  # Reversal potential for slow inhibitory input in mV
        },
...
neurons = sim.Population(4, sim.RoessertEtAl(**parameters['neurons']))
...
filename = normalized_filename("Results", "roessert_etal_neuron", "pkl",
