...
def issue622(sim):
    ...
    assert_equal(set(w4),
                 set([
                     (0.0, 0.0, 0.015), (0.0, 1.0, 0.015), (0.0, 2.0, 0.015), (0.0, 3.0, 0.015), (0.0, 4.0, 0.015), (0.0, 5.0, 0.015),
                                        (1.0, 1.0, 0.015), (1.0, 2.0, 0.015), (1.0, 3.0, 0.015), (1.0, 4.0, 0.015), (1.0, 5.0, 0.015),
                     (2.0, 0.0, 0.015),                    (2.0, 2.0, 0.015), (2.0, 3.0, 0.015), (2.0, 4.0, 0.015), (2.0, 5.0, 0.015),
                 ]))
